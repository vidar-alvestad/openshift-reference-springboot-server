...
Standard Auroraendepunkt
include::{snippets}/aurora/curl-request.adoc[]

Respons::
include::{snippets}/aurora/http-response.adoc[]
//include::{snippets}/database-create/response-fields.adoc[]
